...
def main(country, list_countries, local_port, tor_port, verbose, skip_verify, kill, clear_cache, watchdog_interval, fail_threshold, rate_limit_hosts, headless, status_port, rotate_every):
    if kill:
        info = read_pid()
        if not info:
